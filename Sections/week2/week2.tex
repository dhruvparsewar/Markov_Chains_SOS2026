...
\subsection{\textcolor{secondary}{Markov Property (Memorylessness)}}
...
\subsection{\textcolor{secondary}{One-Step Transition Probabilities ($P_{ij}$)}}
...
\subsection{\textcolor{secondary}{Transition Probability Matrix ($P$)}}
