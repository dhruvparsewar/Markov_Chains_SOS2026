...
\section*{\textcolor{secondary}{1. Environment Representation (The MDP)}}
...
\section*{\textcolor{secondary}{2. The Transition Matrix ($P$) and Stochasticity}}
...
\section*{\textcolor{secondary}{3. The Learning Loop: Updating the Q-Table}}
