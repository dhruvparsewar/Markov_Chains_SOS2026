...
% Title layout matching the Probability notes, but without an author
\title{\vspace{-2cm}\textbf{\textcolor{primary}{Introduction to Markov Chains}}}
...
\maketitle
\vspace{-1.5cm} % Pulls the first section up slightly since there is no author/date
